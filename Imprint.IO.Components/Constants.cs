...
namespace Imprint.IO.Components
{
	...
	{
		public static string XPathScript = @"
	...
	(function (global, factory) {
		if (typeof define === 'function' && define.amd) {
			...
			global.Xpath = factory();
  }}

	(this, function () {
	// src https://github.com/firebug/firebug/blob/a70db2a44f87ce37b6825734221e8ae111f7bb68/extension/content/firebug/lib/xpath.js
	// unfortunately, getElementXPath is going to give you the longest and most exact xpath possible, when
	// you are often more likely to want something that is short and possibly a bit fuzzy, e.g. more like a CSS selector
	// than like an xpath. In those cases, you can manually construct a CSS selector and use cssToXpath. You'd still
	// probably want to edit the result a bit, but its a start.
	...
	// ********************************************************************************************* //
			...
			// Required? Can it not be dealt with <a> tag? //
			var val = Xpath.getElementsByXPath(document, xpath).toString();
